...
=======
          ...
          <span class="fw-bold fs-5 text-dark">남서울대학교 캡스톤 디자인 </span>
        </div>
...
<<<<<<< HEAD
          <button
              class="nav-link btn-aside text-start w-100 d-flex align-items-center gap-2"
              :class="{ 'text-bold text-primary': isActive('/AdminHome') }"
              @click="goTo('/AdminHome')"
              style="color: black;"
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="m16 2l5 5v14.008a.993.993 0 0 1-.993.992H3.993A1 1 0 0 1 3 21.008V2.992C3 2.444 3.445 2 3.993 2zm-4 9.5a2.5 2.5 0 1 0 0-5a2.5 2.5 0 0 0 0 5M7.527 17h8.946a4.5 4.5 0 0 0-8.946 0"/></svg>
=======
...
<<<<<<< HEAD
          <button
              class="nav-link btn-aside text-start w-100 text-bold d-flex align-items-center gap-2"
              :class="{ 'text-bold text-primary': isActive('/AdminAutomation') }"
              @click="goTo('/AdminAutomation')"
              style="color: black;"
          >
...
=======
            ...
            <small class="mt-1 text-nowrap text-medium">가까운 대피소</small>
>>>>>>> origin/develop
          </button>
        </li>
...
=======
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24">
              ...
              <g fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round">
                ...
                <!-- (1) 지우개 레이어: 핀/통계 뒤 격자선 가리기 -->
                <g stroke="#fff" stroke-width="3.4">
                  <!-- 위치 핀 -->
                  <path
                    d="M12 8.6c-1.2 0-2.2.95-2.2 2.12c0 1.66 2.2 4.18 2.2 4.18s2.2-2.52 2.2-4.18c0-1.17-1-2.12-2.2-2.12z" />
                  <circle cx="12" cy="10.7" r="0.6" />
                  <!-- 통계 막대 -->
                  <path d="M6.6 16.9v2.1" />
                  <path d="M8.9 15.8v3.2" />
                  <path d="M11.2 14.9v4.1" />
                </g>
            ...
            <small class="mt-1 text-nowrap text-medium">공간분석 결과</small>
>>>>>>> origin/develop
          </button>
        </li>
...
=======
            ...
            <small class="mt-1 text-nowrap text-medium">게시판 및 건의사항</small>
>>>>>>> origin/develop
          </button>
        </li>
...
=======
            ...
            <small class="mt-1 text-nowrap text-medium">내 정보</small>
>>>>>>> origin/develop
          </button>
        </li>
      </ul>
...
=======
    ...
    checkAuthStatus() {
      // 로그인 상태 확인
      this.status = isAuthenticated() ? '로그아웃' : '로그인'
>>>>>>> origin/develop
    }
  },
...
.admin-aside {
  ...
  bottom: 0;
<<<<<<< HEAD
  padding-top: 72px; /* 상단 네비(고정 헤더)가 있으면 높이 맞춤. 없으면 0으로 바꿔도 됨 */
=======
  padding-top: 72px;
